...
methods_list.append({
    ...
    "neo4j_service_url" : "http://devapi.opentreeoflife.org/taxomachine/ext/tnrs/graphdb/match_names",
    "example_command" : "",
    "example_result" : "",
})
...
methods_list.append({
    ...
    "neo4j_service_url" : "http://devapi.opentreeoflife.org/taxomachine/ext/tnrs/graphdb/autocomplete_name",
    "example_command" : "",
    "example_result" : "",
})
...
methods_list.append({
    ...
    "neo4j_service_url" : "http://devapi.opentreeoflife.org/taxomachine/ext/tnrs/graphdb/contexts",
    "example_command" : "",
    "example_result" : "",
})
...
methods_list.append({
    ...
    "neo4j_service_url" : "http://devapi.opentreeoflife.org/taxomachine/ext/tnrs/graphdb/infer_context",
    "example_command" : "",
    "example_result" : "",
})
