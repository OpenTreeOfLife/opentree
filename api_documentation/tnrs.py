...
methods_list.append({
    ...
    "neo4j_service_url" : "https://api.opentreeoflife.org/v2/tnrs/match_names",
    "example_command" : """curl -X POST https://api.opentreeoflife.org/v2/tnrs/match_names \\\n-H "content-type:application/json" -d \\\n'{"names":["Aster","Symphyotrichum","Erigeron","Barnadesia"]}'""",
    "example_result" : "",
})
...
methods_list.append({
    ...
    "neo4j_service_url" : "https://api.opentreeoflife.org/v2/tnrs/autocomplete_name",
    "example_command" : """curl -X POST https://api.opentreeoflife.org/v2/tnrs/autocomplete_name \\\n-H "content-type:application/json" -d \\\n'{"name":"Endoxyla","context_name":"All life"}'""",
    "example_result" : "",
})
...
methods_list.append({
    ...
    "neo4j_service_url" : "https://api.opentreeoflife.org/v2/tnrs/contexts",
    "example_command" : """curl -X POST https://api.opentreeoflife.org/v2/tnrs/contexts""",
    "example_result" : "",
})
...
methods_list.append({
    ...
    "neo4j_service_url" : "https://api.opentreeoflife.org/v2/tnrs/infer_context",
    "example_command" : """curl -X POST https://api.opentreeoflife.org/v2/tnrs/infer_context \\\n-H "content-type:application/json" -d \\\n'{"names":["Pan","Homo","Mus","Bufo","Drosophila"]}'""",
    "example_result" : "",
})
