...
methods_list.append({
    ...
    "neo4j_service_url" : "https://api.opentreeoflife.org/v2/tree_of_life/about",
    "example_command" : """curl -X POST https://api.opentreeoflife.org/v2/tree_of_life/about -H "content-type:application/json"  -d '{"study_list":false}'
""",
    "example_result" : "",
})
...
methods_list.append({
    ...
    "neo4j_service_url" : "https://api.opentreeoflife.org/v2/tree_of_life/mrca",
    "example_command" : """curl -X POST https://api.opentreeoflife.org/v2/tree_of_life/mrca -H "content-type:application/json" -d '{"ott_ids":[412129, 536234]}'""",
    "example_result" : "",
})
...
methods_list.append({
    ...
    "neo4j_service_url" : "https://api.opentreeoflife.org/v2/tree_of_life/subtree",
    "example_command" : """curl -X POST https://api.opentreeoflife.org/v2/tree_of_life/subtree -H "content-type:application/json" -d '{"ott_id":3599390}'""",
    "example_result" : "",
})
...
methods_list.append({
    ...
    "neo4j_service_url" : "https://api.opentreeoflife.org/v2/tree_of_life/induced_subtree",
    "example_command" : """curl -X POST https://api.opentreeoflife.org/v2/tree_of_life/induced_subtree -H "content-type:application/json" -d '{"ott_ids":[292466, 501678, 267845, 666104, 316878, 102710, 176458]}'""",
    "example_result" : "",
})
