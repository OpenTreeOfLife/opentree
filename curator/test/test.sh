...
python test2nexml.py "${CURATOR_DOMAIN}/curator/default/to_nexson?nexml2json=1.2.0" avian_ovomucoids.tre newick >.out.aot.v1.2.0.txt || exit
python test2nexml.py "${CURATOR_DOMAIN}/curator/default/to_nexson?nexml2json=1.0.0" avian_ovomucoids.tre newick >.out.aot.v1.0.0.txt || exit
python test2nexml.py "${CURATOR_DOMAIN}/curator/default/to_nexson?nexml2json=0.0.0" avian_ovomucoids.tre newick >.out.aot.v0.0.0.txt || exit
