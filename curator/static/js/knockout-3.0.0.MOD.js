...
ko.expressionRewriting = (function () {
    ...
    function preProcessBindings(bindingsStringOrKeyValueArray, bindingContext, bindingOptions) {

        if (!bindingContext) {
            bindingContext = new ko.bindingContext(); // TODO
        }
        ...
        function processKeyValue(key, val) {
            ...
            function callPreprocessHook(obj) {
                return (obj && obj['preprocess']) ? (val = obj['preprocess'](val, key, processKeyValue, bindingContext)) : true;
            }
...
(function() {
    ...
    ko.utils.extend(ko.bindingProvider.prototype, {
        ...
        'parseBindingsString': function(bindingsString, bindingContext, node, options) {
            try {
                var bindingFunction = createBindingsStringEvaluatorViaCache(bindingsString, bindingContext, this.bindingCache, options);
    ...
    function createBindingsStringEvaluatorViaCache(bindingsString, bindingContext, cache, options) {
        var cacheKey = bindingsString + (options && options['valueAccessors'] || '');
        return cache[cacheKey]
            || (cache[cacheKey] = createBindingsStringEvaluator(bindingsString, bindingContext, options));
    }

    function createBindingsStringEvaluator(bindingsString, bindingContext, options) {
        // Build the source for a function that evaluates "expression"
        // For each scope variable, add an extra level of "with" nesting
        // Example result: with(sc1) { with(sc0) { return (expression) } }
        var rewrittenBindings = ko.expressionRewriting.preProcessBindings(bindingsString, bindingContext, options),
...
ko.templateRewriting = (function () {
    ...
    function constructMemoizedTagReplacement(dataBindAttributeValue, tagToRetain, nodeName, templateEngine) {
        ...
        var rewrittenDataBindAttributeValue = ko.expressionRewriting.preProcessBindings(dataBindKeyValueArray, bindingContext, {'valueAccessors':true});
